...
">坤音乐播放平台</h3><div style="font-size: 16px;margin-top: 26px;line-height: 30px;color: #999;
">QQ交流群:1025681344<a href=""><b>坤音乐</b></a></div><a style="display: block;background: #98a3ff;color: #FFF;text-align: center;font-weight: bold;font-size: 19px;line-height: 60px;margin: 0 auto;margin-top: 45px;border-radius: 32px;width:50%;" onclick="javascript:document.querySelector('.web_notice').remove()">我知道了</ a></div></div>
